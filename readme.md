...
- In the Dev Tools, change the image in the About Our Products section to have a width of 100 pixels. Once you have that in the Dev Tools, add a class to the image in the HTML file and use CSS to make the change permanent in the CSS file.
